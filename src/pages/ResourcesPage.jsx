                ...
                <div className={styles.side}>
                    ...
                    <div className={styles.navigatorMain}>
                        <div className={styles.navigatorWrapper}>
                            <p className={classNames(styles.naviTitle, 'title_20x')}>Resources</p>
                            <ul className={styles.navigator}>
                                <li className={styles.menuWrapper}>
                                    <a className={classNames(styles.menu, 'body_16x')}>Design story</a>
                                </li>
                                <li className={styles.menuWrapper}>
                                    <a className={classNames(styles.menu, 'body_16x')}>BX guidelines</a>
                                </li>
                                <li className={styles.menuWrapper}>
                                    <a className={classNames(styles.menu, 'body_16x')}>UX guidelines</a>
                                </li>
                            </ul>
                        </div>
                    </div>
